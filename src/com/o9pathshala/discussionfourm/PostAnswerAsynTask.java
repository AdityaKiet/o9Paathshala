...
public class PostAnswerAsynTask extends AsyncTask<String, String, Void> implements SQLConstants{
	...
	public PostAnswerAsynTask(final Context context, ExploredQuestionDTO exploredQuestionDTO, String query) {
	...
	protected void onPostExecute(Void v) {
		...
		if(result.equals("true")){
			Toast.makeText(context.getApplicationContext().getApplicationContext(),"Answer submitted", Toast.LENGTH_LONG).show();
			...
			Toast.makeText(context.getApplicationContext().getApplicationContext(),"Answer not submitted", Toast.LENGTH_LONG).show();
