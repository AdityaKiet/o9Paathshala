...
public class LikeAnswerAsynTask extends AsyncTask<String, String, Void> implements SQLConstants{
	...
	public LikeAnswerAsynTask(final Context context, ExploredQuestionDTO exploredQuestionDTO, String query) {
		...
		TimerTask task = new TimerTask() {
			...
			public void run() {
				...
				((Activity)context).runOnUiThread(new Runnable() {
					...
					@Override
					public void run() {
						if(null != context && LikeAnswerAsynTask.this.isCancelled())
	...
	protected void onPreExecute() {
		...
		progressDialog.setOnCancelListener(new OnCancelListener() {
			...
			public void onCancel(DialogInterface arg0) {
				LikeAnswerAsynTask.this.cancel(true);
			}
		});
		super.onPreExecute();
	}
